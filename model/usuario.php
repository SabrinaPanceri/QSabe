...
function buscaperguntas(){
        ...
        while($row = mysqli_fetch_assoc($result)){
            $html = '<div class="post"> <div class="entry"><p>#'.$row["idpergunta"].' <a href="/qsabe/view/view_pergunta.php?pergunta='.$row["idpergunta"].'">'.$row["desc_pergunta"].'</a></p></br></br> date:'.$row["data_reg"].' </div> </div>';
